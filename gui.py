...
from helpers import CP_LENGTHS, NCARRIERS, ZC_SYMBOL_IDX, CP_LENGTHS_legacy, ZC_SYMBOL_IDX_legacy
...
def interactive(packet):
    ...
    def update(_):
        ...
        for s, _ in enumerate(CP_LENGTHS_legacy):
